    ...
    for type_i = {'1km','topunit','default'}
        ...
        elseif strcmp(type_i,'topunit')
          ...
          % f2ds_top_cols = repmat(f2ds_top_cols, 1, 12);
            ...
            fsno_pp_mean = nansum(fsnos_pps.*f2ds_top_col);
            ...
            fsno_pp_std = std(fsnos_pps,f2ds_top_col, 1,'omitnan');
        ...
        elseif strcmp(type_i,'default')
            ...
            %f2ds_top_default = repmat(f2ds_top_default, [1 1]);
            f2ds_pp_ppunit = repmat(f2ds_top_topunit, [1 1]);
        ...
        hold on
        time = (1:12)';
        plot(time, fsa_pp_mean, 'k', 'LineWidth', 1);
