...
for grid_i = 1:1
    ...
    for type_i = {'1km','topunit','default'}
        ...
        if strcmp(type_i,'1km')
            ...
            fpsn_pp_std = nanstd(fpsns_pps_all,1, [1 2]);
    ...
    legend(hax1,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax1,'DOY')
    ylabel(hax1,'std')
    ...
    legend(hax2,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax2,'DOY')
    ylabel(hax2,'std')
    ...
    legend(hax3,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax3,'DOY')
    ylabel(hax3,'std')
    ...
    legend(hax4,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax4,'DOY')
    ylabel(hax4,'std')
    ...
    legend(hax5,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax5,'DOY')
    ylabel(hax5,'std')
    ...
    legend(hax6,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax6,'DOY')
    ylabel(hax6,'mean')
    ...
    legend(hax7,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax7,'DOY')
    ylabel(hax7,'mean')
    ...
    legend(hax8,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax8,'DOY')
    ylabel(hax8,'mean')
    ...
    legend(hax9,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax9,'DOY')
    ylabel(hax9,'mean')
    ...
    legend(hax10,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax10,'DOY')
    ylabel(hax10,'mean')
    ...
    legend(hax11,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax11,'DOY')
    ylabel(hax11,'cv')
    ...
    legend(hax12,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax12,'DOY')
    ylabel(hax12,'cv')
    ...
    legend(hax13,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax13,'DOY')
    ylabel(hax13,'cv')
    ...
    legend(hax14,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax14,'DOY')
    ylabel(hax14,'cv')
    ...
    legend(hax15,'1km-top','1km-pp','topunit-pp','default-pp')
    xlabel(hax15,'DOY')
    ylabel(hax15,'cv')
    ...
    print(gcf1, '-dsvg', '-r300', ['figures_all/std_fsa_' num2str(grid_i)  '.svg'])
    print(gcf2, '-dsvg', '-r300', ['figures_all/std__fsno_' num2str(grid_i)  '.svg'])
    print(gcf3, '-dsvg', '-r300', ['figures_all/std__lh_' num2str(grid_i)  '.svg'])
    print(gcf4, '-dsvg', '-r300', ['figures_all/std__sh_' num2str(grid_i)  '.svg'])
    print(gcf5, '-dsvg', '-r300', ['figures_all/std__fspn_' num2str(grid_i) '.svg'])
    
    print(gcf6, '-dsvg', '-r300', ['figures_all/mean_fsa_' num2str(grid_i)  '.svg'])
    print(gcf7, '-dsvg', '-r300', ['figures_all/mean_fsno_' num2str(grid_i)  '.svg'])
    print(gcf8, '-dsvg', '-r300', ['figures_all/mean_lh_' num2str(grid_i)  '.svg'])
    print(gcf9, '-dsvg', '-r300', ['figures_all/mean_sh_' num2str(grid_i)  '.svg'])
    print(gcf10, '-dsvg', '-r300', ['figures_all/mean_fspn_' num2str(grid_i) '.svg'])
    
    
    print(gcf11, '-dsvg', '-r300', ['figures_all/cv_fsa_' num2str(grid_i)  '.svg'])
    print(gcf12, '-dsvg', '-r300', ['figures_all/cv_fsno_' num2str(grid_i)  '.svg'])
    print(gcf13, '-dsvg', '-r300', ['figures_all/cv_lh_' num2str(grid_i)  '.svg'])
    print(gcf14, '-dsvg', '-r300', ['figures_all/cv_sh_' num2str(grid_i)  '.svg'])
    print(gcf15, '-dsvg', '-r300', ['figures_all/cv_fspn_' num2str(grid_i) '.svg'])
