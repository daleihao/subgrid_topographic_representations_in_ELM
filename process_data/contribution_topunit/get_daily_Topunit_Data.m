    ...
    file_i = file_i{1};
     ...
     for doy_i = 1:365        
        for year_i = 2000:2010
            ...
            file_top_tmp = [DataTopDir file_i 'elm_plevel_top_11years_' type_i '_grid' num2str(grid_i) '_CLM_USRDAT.ICLM45.intel.clm2.h1.' num2str(year_i)  '-' num2str(month_i, '%02d') '-' num2str(day_i, '%02d')  '-00000.nc'];
            file_pp_tmp = [DataPPDir file_i 'elm_plevel_notop_11years_' type_i '_grid'  num2str(grid_i) '_CLM_USRDAT.ICLM45.intel.clm2.h1.' num2str(year_i)   '-' num2str(month_i, '%02d') '-' num2str(day_i, '%02d')  '-00000.nc'];
        ...
        %% save
        save([ 'topunit/' file_i 'daily_11year_average_' type_i '_grid_' num2str(grid_i) '_plevel_doy_'  num2str(doy_i) '.mat'], 'lhs_tops',  'shs_tops',   'rhos_tops',  'tsas_tops',    'qs_tops' ,       'ufs_tops',         'psurfs_tops', ...
