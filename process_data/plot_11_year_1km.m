...
for grid_i = 1
    ...
    load(['data/' '11year_average_1km_grid_' num2str(grid_i) '.mat']);
    %% %%%%%%%%%%%% 1km
    ...
    for month_i = 8
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSA_TOP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSA_PP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSA_difference.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSH_TOP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSH_PP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSH_difference.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSNO_TOP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSNO_PP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FSNO_difference.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FPSN_TOP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FPSN_PP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_FPSN_difference.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300',  ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_LH_TOP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_LH_PP.svg'])
        ...
        colorbar
        print(gcf, '-dsvg', '-r300', ['figures/11year_' num2str(grid_i) '_'  num2str(month_i) '_LH_difference.svg'])
        close all
