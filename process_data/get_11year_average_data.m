...
for grid_i = 1:4
    for type_i = {'1km','topunit','default'}
        DataDir = ['/global/cscratch1/sd/daleihao/e3sm_scratch/cori-knl/' 'elm_top_11years_' type_i '_grid' num2str(grid_i) '_CLM_USRDAT.ICLM45.intel' ];
        
        for year_i = 2000:2010
            %% import data
            file_top_tmp = [DataDir 'elm_top_11years_' type_i '_grid' num2str(grid_i) '_CLM_USRDAT.ICLM45.intel.clm2.h2.' num2str(year_i)  '-02-01-00000.nc'];
            file_pp_tmp = [DataDir 'elm_notop_11years_' type_i '_grid'  num2str(grid_i) ' _CLM_USRDAT.ICLM45.intel.clm2.h2.' num2str(year_i)  '-02-01-00000.nc'];
        ...
        %% save
        save([ type_i '_grid_' num2str(grid_i) '.mat'], 'lhs_tops',  'shs_tops',   'rhos_tops',  'tsas_tops',    'qs_tops' ,       'ufs_tops',         'psurfs_tops', ...
