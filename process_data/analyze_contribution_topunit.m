...
for grid_i = 1:1
    ...
    for type_i = {'topunit','no_soil','no_LAI','default'}
        
        type_i = type_i{1};
        if strcmp(type_i,'topunit') | strcmp(type_i,'default') 
        load(['data/' 'all_daily_11year_average_' type_i '_grid_' num2str(grid_i) '_plevel.mat']);
        else
             load(['data/' type_i '_daily_11year_average_' 'topunit' '_grid_' num2str(grid_i) '_plevel.mat']);
        end
        ...
        elseif strcmp(type_i,'topunit') |  strcmp(type_i,'no_soil') |  strcmp(type_i,'no_LAI') 
