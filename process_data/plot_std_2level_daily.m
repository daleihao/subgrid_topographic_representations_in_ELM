...
for grid_i = 1:4
    ...
    print(gcf1, '-dsvg', '-r300', ['figures/zoom_all_mean_daily_fsa_' num2str(grid_i)  '.svg'])
    print(gcf2, '-dsvg', '-r300', ['figures/zoom_all_mean_daily_fsno_' num2str(grid_i)  '.svg'])
    print(gcf3, '-dsvg', '-r300', ['figures/zoom_all_mean_daily_lh_' num2str(grid_i)  '.svg'])
    print(gcf4, '-dsvg', '-r300', ['figures/zoom_all_mean_daily_sh_' num2str(grid_i)  '.svg'])
    print(gcf5, '-dsvg', '-r300', ['figures/zoom_all_mean_daily_fspn_' num2str(grid_i) '.svg'])
    
    print(gcf6, '-dsvg', '-r300', ['figures/zoom_all_std_daily_fsa_' num2str(grid_i)  '.svg'])
    print(gcf7, '-dsvg', '-r300', ['figures/zoom_all_std_daily_fsno_' num2str(grid_i)  '.svg'])
    print(gcf8, '-dsvg', '-r300', ['figures/zoom_all_std_daily_lh_' num2str(grid_i)  '.svg'])
    print(gcf9, '-dsvg', '-r300', ['figures/zoom_all_std_daily_sh_' num2str(grid_i)  '.svg'])
    print(gcf10, '-dsvg', '-r300', ['figures/zoom_all_std_daily_fspn_' num2str(grid_i) '.svg'])
    
    
    print(gcf11, '-dsvg', '-r300', ['figures/zoom_all_cv_daily_fsa_' num2str(grid_i)  '.svg'])
    print(gcf12, '-dsvg', '-r300', ['figures/zoom_all_cv_daily_fsno_' num2str(grid_i)  '.svg'])
    print(gcf13, '-dsvg', '-r300', ['figures/zoom_all_cv_daily_lh_' num2str(grid_i)  '.svg'])
    print(gcf14, '-dsvg', '-r300', ['figures/zoom_all_cv_daily_sh_' num2str(grid_i)  '.svg'])
    print(gcf15, '-dsvg', '-r300', ['figures/zoom_all_cv_daily_fspn_' num2str(grid_i) '.svg'])
