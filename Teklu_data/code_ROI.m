...
ElevationData_all = imread('SierraNevada_tpu_map.tif');
...
colorbar
print(gcf, '-dsvg', '-r300', 'results/Topunit1.svg')
...
plot_global_map(lats3, lons3, tile3, 1, 11, "Grid-3", colors, 1, 1);
colorbar
print(gcf, '-dsvg', '-r300', 'results/Topunit3.svg')
...
plot_global_map(lats4, lons4, tile4, 1, 11, "Grid-4", colors, 1, 1);
colorbar
print(gcf, '-dsvg', '-r300', 'results/Topunit4.svg')
